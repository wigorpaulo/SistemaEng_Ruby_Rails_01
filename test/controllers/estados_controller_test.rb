...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { descricao: @estado.descricao, id_pais: @estado.id_pais, uf: @estado.uf } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { descricao: @estado.descricao, id_pais: @estado.id_pais, uf: @estado.uf } }
