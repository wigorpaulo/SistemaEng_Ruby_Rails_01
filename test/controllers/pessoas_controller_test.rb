...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { cpf: @pessoa.cpf, id_empresa: @pessoa.id_empresa, nome: @pessoa.nome } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { cpf: @pessoa.cpf, id_empresa: @pessoa.id_empresa, nome: @pessoa.nome } }
