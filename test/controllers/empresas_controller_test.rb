...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { fantasia: @empresa.fantasia, id_endereco: @empresa.id_endereco, logo_tipo: @empresa.logo_tipo, razao_social: @empresa.razao_social } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { fantasia: @empresa.fantasia, id_endereco: @empresa.id_endereco, logo_tipo: @empresa.logo_tipo, razao_social: @empresa.razao_social } }
