...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { cnpj: @fornecedor.cnpj, fantasia: @fornecedor.fantasia, razao_social: @fornecedor.razao_social } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cnpj: @fornecedor.cnpj, fantasia: @fornecedor.fantasia, razao_social: @fornecedor.razao_social } }
