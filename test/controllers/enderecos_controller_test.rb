...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { complemento: @endereco.complemento, descricao: @endereco.descricao, id_bairro: @endereco.id_bairro, id_cep: @endereco.id_cep, numero: @endereco.numero } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { complemento: @endereco.complemento, descricao: @endereco.descricao, id_bairro: @endereco.id_bairro, id_cep: @endereco.id_cep, numero: @endereco.numero } }
