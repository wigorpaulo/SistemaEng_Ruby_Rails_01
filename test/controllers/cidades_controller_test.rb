...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { descricao: @cidade.descricao, id_estado: @cidade.id_estado } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { descricao: @cidade.descricao, id_estado: @cidade.id_estado } }
